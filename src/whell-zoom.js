// taken https://github.com/phparkle/disable-scroll-wheel-zoom
...
document.addEventListener(
  ...
  function (event) {
    ...
    if (event.ctrlKey) {
      ...
      //console.log('Scroll Zoom Extension called')
  ...
  { passive: false }
) // Specify that the event is not passive, allowing preventDefault() to be called
